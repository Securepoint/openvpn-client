...
**
** Created: Fri 23. Oct 10:54:38 2009
...
public:
    ...
    void setupUi(QDialog *Preferences)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/inaktiv.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/info.svg"), QSize(), QIcon::Normal, QIcon::Off);
        cmdInfoClient->setIcon(icon1);
        ...
        cmdInfoAuthUserPass->setIcon(icon1);
        ...
        cmdInfoServerCertificate->setIcon(icon1);
        ...
        cmdInfoLinuxUser->setIcon(icon1);
        cmdInfoLinuxUser->setFlat(true);
        tbSettings->addItem(page_3, QString::fromUtf8("Linux"));
        page_2 = new QWidget();
        page_2->setObjectName(QString::fromUtf8("page_2"));
        page_2->setGeometry(QRect(0, 0, 421, 419));
        groupBox_6 = new QGroupBox(page_2);
        groupBox_6->setObjectName(QString::fromUtf8("groupBox_6"));
        groupBox_6->setGeometry(QRect(0, 1, 421, 131));
        ...
        cmdInfoWinRouteMethod->setIcon(icon1);
        ...
        cmdInfoWinDevNode->setIcon(icon1);
        cmdInfoWinDevNode->setFlat(true);
        tbSettings->addItem(page_2, QString::fromUtf8("Windows"));
        page_4 = new QWidget();
        ...
        cmdInfoAdvRandomHost->setIcon(icon1);
        ...
        cmdInfoMuteWirelessWarnings->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/connecting.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/connected.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *Preferences)
    {
        ...
        groupBox_10->setTitle(QApplication::translate("Preferences", "Downgrade Privileges:", 0, QApplication::UnicodeUTF8));
        ...
        tbSettings->setItemText(tbSettings->indexOf(page_3), QApplication::translate("Preferences", "Linux", 0, QApplication::UnicodeUTF8));
        ...
        tbSettings->setItemText(tbSettings->indexOf(page_2), QApplication::translate("Preferences", "Windows", 0, QApplication::UnicodeUTF8));
